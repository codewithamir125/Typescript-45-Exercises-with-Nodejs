...
// accept an arbitrary number of keyword arguments. Call the function with the required information 
...
function create_car(manufacuturer, model, ...options ){

    // Initilizing a car object with manufacturer and model
