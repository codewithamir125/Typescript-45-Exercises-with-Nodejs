...
// Q25.Alien Colors #1: Imagine an alien was just shot down in a game. Create a variable called 
...
if (alienColor === "Black"){
    //code Block
    console.log(" Aliean color is Black Player just earned 5 points.")
}
